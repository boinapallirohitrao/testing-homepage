! function(a, b, c, d) {
    ...
    e.prototype = {
        public: function() { return { startDate: moment().startOf("day"), endDate: moment().startOf("day"), format: "L", dateSeparator: " - ", calendarCount: 2, inline: !1, minDate: null, maxDate: null, showHeader: !0, showFooter: !0, showButtons: !1, startOnMonday: !1, container: "body", oneCalendarWidth: 230, enableKeyboard: !0, showOn: "bottom", autoAlign: !0, locale: moment.locale(), singleDate: !1, target: null, autoCloseOnSelect: !1, startEmpty: !1, ranges: [{ title: "Today", startDate: moment(), endDate: moment() }, { title: "3 Days", startDate: moment(), endDate: moment().add(2, "days") }, { title: "5 Days", startDate: moment(), endDate: moment().add(4, "days") }, { title: "1 Week", startDate: moment(), endDate: moment().add(6, "days") }, { title: "Till Next Week", startDate: moment(), endDate: moment().endOf("week") }, { title: "Till Next Month", startDate: moment(), endDate: moment().endOf("month") }], rangeLabel: "Ranges: ", cancelLabel: "Cancel", applyLabel: "Apply", onbeforeselect: function() { return !0 }, onafterselect: function() {}, onbeforeshow: function() {}, onbeforehide: function() {}, onaftershow: function() {}, onafterhide: function() {}, onfirstselect: function() {}, onrangeselect: function() {}, onbeforemonthchange: function() { return !0 }, onaftermonthchange: function() {}, ondraw: function() {}, oninit: function() {}, disableDays: function() { return !1 }, disabledRanges: [], continuous: !1, enableMonthSwitcher: !0, enableYearSwitcher: !0, numericMonthSwitcher: !1 } },
        private: function() { return { startSelected: !1, currentDate: moment().startOf("day"), endSelected: !0, hoverDate: null, keyboardHoverDate: null, headerStartDay: null, headerStartDate: null, headerStartWeekday: null, headerEndDay: null, headerEndDate: null, headerEndWeekday: null, swipeTimeout: null, isMobile: !1, valElements: ["BUTTON", "OPTION", "INPUT", "LI", "METER", "PROGRESS", "PARAM"], dontHideOnce: !1, initiator: null, initComplete: !1, startDateBackup: null, startDateInitial: null, endDateInitial: null, firstValueSelected: !1, throttleTimeout: null, documentEvent: null, delayInputUpdate: !1 } },
        init: function() { return this.config = a.extend({}, this.public(), this.options, this.metadata), this.globals = a.extend({}, this.private()), this.globals.isMobile = this.checkMobile(), this.applyConfig(), this.fetchInputs(), this.drawUserInterface(), this.addInitialEvents(), this.addKeyboardEvents(), this.$elem.data("caleran", this), this.config.oninit(this), this.globals.initComplete = !0, this },
        ...
        fetchInputs: function() {
            ...
            } else if (!0 === this.config.singleDate) { var d = b; "" != d && moment(d, this.config.format, this.config.locale).isValid() && (this.config.startDate = moment(d, this.config.format, this.config.locale).middleOfDay(), this.config.endDate = moment(d, this.config.format, this.config.locale).middleOfDay(), this.globals.firstValueSelected = !0) }
        ...
        drawCalendarOfMonth: function(a) {
            ...
            for (; e < 42;) {
                ...
                d += "<div class='" + (a.month() == c.month() ? "caleran-day" : "caleran-disabled") + "' data-value='" + j + "'><span>" + c.date() + "</span></div>", c.add(moment.duration({ days: 1 })), e++
            }
        ...
        drawFooter: function() {
            ...
            this.globals.isMobile && !this.config.inline && (!0 !== this.config.singleDate && !1 !== this.config.showFooter || this.input.append("<div class='caleran-filler'></div>")),
                (this.globals.isMobile && !this.config.inline || !this.globals.isMobile && !this.config.inline && this.config.showButtons) && (this.input.append("<div class='caleran-footer'></div>"),
                    ...
                    this.footer.append("<button type='button' class='caleran-cancel'>" + this.config.cancelLabel + "</button>"), !1 === this.globals.firstValueSelected && 1 == this.config.startEmpty && this.footer.find(".caleran-apply").attr("disabled", "disabled"))
        },
        ...
        checkRangeContinuity: function() {
            ...
            for (var c = this.config.endDate.diff(this.config.startDate, "days"), d = moment(this.config.startDate), e = function(c) { return a.grep(b.config.disabledRanges, function(a) { return c.isBetween(a.start, a.end, "day", "[]") }) }, f = 0; f <= c; f++) {
                if (e(d).length > 0 || !0 === this.config.disableDays(d)) return !1;
                d.middleOfDay().add(1, "days")
            }
            return !0
        },
        isDisabled: function(a) { if (!0 === this.config.disableDays(moment(a).middleOfDay())) return !0; for (var b = 0; b < this.config.disabledRanges.length; b++) { var c = this.config.disabledRanges[b]; if (moment(a).isBetween(c.start, c.end, "day", "[]")) return !0 } return !1 },
        ...
        monthSwitchClicked: function() {
            if (!(this.calendars.find(".caleran-month-selector").length > 0)) {
                ...
                for (var c = a("<div class='caleran-month-selector'></div>").appendTo(this.calendars), d = this.globals.currentDate.get("month"), e = 0; e < 12; e++) c.append("<div class='caleran-ms-month" + (d == e ? " current" : "") + "' data-month='" + e + "'>" + (this.config.numericMonthSelector ? e + 1 : moment({ day: 15, hour: 12, month: e }).locale(this.config.locale).format("MMMM")) + "</div>");
                c.css("display", "block"), this.optimizeFontSize(c.find(".caleran-ms-month")), c.find(".caleran-ms-month").off("click").on("click", function(c) { b.globals.currentDate.month(a(this).data("month")), b.reDrawCalendars(), b.calendars.find(".caleran-month-selector").remove(), b.stopBubbling(c) })
            }
        },
        ...
        showDropdown: function(c) { c = c || b.event, c.target = c.target || c.srcElement, (!this.globals.isMobile && "none" == this.container.css("display") || this.globals.isMobile && "none" == this.input.css("display")) && (c.target !== this.elem && (this.globals.dontHideOnce = !0, this.globals.initiator = c.target), this.fetchInputs(), this.globals.startDateInitial = this.config.startDate, this.globals.endDateInitial = this.config.endDate, this.reDrawCalendars(), this.config.onbeforeshow(this), this.globals.isMobile ? (this.input.css({ display: "flex" }), a("body").addClass("caleran-open")) : this.container.css({ display: "block" }), this.setViewport(), this.config.onaftershow(this)) },
        ...
        positionOnBottom: function(a) {
            var b = this.getDimensions(this.$elem, !0),
                ...
                d = { top: b.offsetTop + b.height - c + 11, left: b.offsetLeft - c };
            if (a) return d;
        ...
        positionOnLeft: function(a) {
            var b = this.getDimensions(this.$elem, !0),
                ...
                e = { top: b.offsetTop - 3 * d, left: b.offsetLeft - c.width - d - 2 };
            if (a) return e;
        ...
        positionOnRight: function(a) {
            var b = this.getDimensions(this.$elem, !0),
                ...
                d = { top: b.offsetTop - 3 * c, left: b.offsetLeft + b.width + c + 2 };
            if (a) return d;
        ...
        positionOnTop: function(a) {
            var b = this.getDimensions(this.$elem, !0),
                c = this.getDimensions(this.container, !0),
                d = parseInt(this.input.css("margin-left"), 10),
                e = { top: b.offsetTop - d - c.height - 2, left: b.offsetLeft - d };
            if (a) return e;
        ...
        getDimensions: function(a, e) {
            ...
            return { width: l.width, height: l.height, offsetTop: l.top + k, offsetLeft: l.left + j }
        },
        getViewport: function() { return { top: b.scrollY || b.pageYOffset, left: b.scrollX || b.pageXOffset, bottom: (b.scrollY || b.pageYOffset) + b.innerHeight, right: (b.scrollX || b.pageXOffset) + b.innerWidth } },
        ...
        stopBubbling: function(a) { void 0 !== a.stopPropagation ? a.stopPropagation() : void 0 !== a.cancelBubble && (a.cancelBubble = !0), void 0 !== a.preventDefault && a.preventDefault(), a.returnValue = !1 },
        ...
        destroy: function() { this.config.inline ? (this.input.remove(), this.globals.isMobile ? this.$elem.unwrap(".caleran-container-mobile") : this.$elem.unwrap(".caleran-container"), this.elem.type = "text") : this.container.remove(), a(c).off(this.globals.documentEvent), this.$elem.removeData("caleran") },
    ...
    }, e.defaults = e.prototype.defaults, a.fn.caleran = function(a) { return this.each(function() { new e(this, a).init() }) }, "function" != typeof moment.fn.middleOfDay && (moment.fn.middleOfDay = function() { return this.hours(12).minutes(0).seconds(0), this }, moment.fn.startOfMonth = function() { return this.middleOfDay().date(1), this })
